...
export default function DirectVoiceCommands() {
      ...
      <button
        onClick={() => {
          if (!isListening) {
            ...
            const instructionsShown = localStorage.getItem('voiceInstructionsShown');
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[9999]">
          <div className="bg-white rounded-lg p-4 max-w-md w-full mx-4">
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
              <div className="bg-gray-100 p-2 rounded text-sm">"Add iPhone to cart"</div>
              <div className="bg-gray-100 p-2 rounded text-sm">"Buy headphones"</div>
              <div className="bg-gray-100 p-2 rounded text-sm">"Samsung TV"</div>
              <div className="bg-gray-100 p-2 rounded text-sm">"Add laptop"</div>
            </div>
            
            <div className="flex justify-end">
              <button
                className="bg-amazon_teal text-white px-4 py-2 rounded font-medium"
                onClick={() => {
